...
const projectsData = [
  {
    id: 1,
    stack: 'Next.js, JavaScript, TailwindCSS, Stripe',
    title: 'JKH Fitness',
    description: 'Local <fictional> fitness establishment',
    image: '/images/projects/jkh_fitness.png',
    tag: ['All', 'Web'],
    gitUrl: 'https://github.com/james-k-h/personal_training',
    previewUrl: 'https://personal-training-phi.vercel.app/',
  },
  {
    id: 2,
